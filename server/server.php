...
$db = mysqli_connect('localhost', 'root', '', 'wisata');
...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM user WHERE nama='$username' OR email='$email' LIMIT 1";
...
if (isset($_POST['login_admin'])) {
  ...
  if (count($errors) == 0) {
    ...
    $query = "SELECT * FROM user WHERE email='$admin_username' AND password='$password'";
